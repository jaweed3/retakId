...
export function DashboardPage() {
  ...
  const { data, counts, isLoading, error, refetch } = useLaporan({ status: statusFilter, limit: 200 });

  return (
    <div className="h-full flex flex-col">
      <div className="flex-1 relative">
        <MapView reports={data} isLoading={isLoading} error={error} onRetry={refetch} className="h-full" />
