...
\begin{figure}[h]
	\centering
	\includegraphics[width=\columnwidth]{diagrams/research-methodology.png}
	\caption{Research methodology flowchart showing the four-phase pipeline: dataset construction, model development, system implementation, and evaluation}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\columnwidth]{diagrams/report-flow.png}
	\caption{Report processing flow from image capture through multi-factor risk assessment to alert delivery across all platforms}
