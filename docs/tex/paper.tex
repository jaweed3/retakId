...
\hypersetup{
  ...
  pdfauthor={Jaweed Fatih, Farrel Ghozy, Adam Nurwahid},
}
...
\author{
  \IEEEauthorblockN{
    Jaweed Fatih\IEEEauthorrefmark{1},
    Farrel Ghozy\IEEEauthorrefmark{2},
    Adam Nurwahid\IEEEauthorrefmark{3}
  }
  \IEEEauthorblockA{
    Informatics Department, Universitas Darussalam Gontor\\
    Ponorogo, Indonesia\\
    Email: \IEEEauthorrefmark{1}fatihalmumtaz76@student.cs.unida.gontor.ac.id,
    \IEEEauthorrefmark{2}farrelghozy@mhs.unida.gontor.ac.id,
    \IEEEauthorrefmark{3}adam.nurwahid@mhs.unida.gontor.ac.id
  }
}
...
\begin{table}[h]
  ...
  \begin{tabular}{lccc}
    ...
    test3 & 03/05 & 81.8\% & Fine-tune 24 layers, LR=$5\times10^{-6}$, aggressive augmentation \\
