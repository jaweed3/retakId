...
echo ""
echo -e "  ${BOLD}MLflow Cloud (liat hasil dari HP):${NC}"
echo -e "    Setup env vars dulu (sekali aja):"
echo -e "    ${CYAN}export MLFLOW_TRACKING_URI=https://dagshub.com/jaweed3/retakId.mlflow${NC}"
echo -e "    ${CYAN}export MLFLOW_TRACKING_USERNAME=jaweed3${NC}"
echo -e "    ${CYAN}export MLFLOW_TRACKING_PASSWORD=<dagshub_token>${NC}"
echo -e "    ${CYAN}mlflow ui${NC}"
echo ""
echo -e "  ${BOLD}Bikin DagsHub token:${NC}"
echo -e "    https://dagshub.com/user/settings/tokens"
echo ""
