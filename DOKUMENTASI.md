...
Supabase sudah menyediakan semua yang dibutuhkan (database, auth, storage, realtime) sebagai Backend-as-a-Service. Membuat REST API sendiri akan menambah kompleksitas dan memerlukan server maintain — tidak cocok untuk proyek lomba dengan sumber daya terbatas.
